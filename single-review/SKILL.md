---
name: single-review
description: Run adversarial code, plan, or PR reviews with exactly one reviewer subagent. Use when the user asks for single review, one reviewer, one subagent review, solo review, non-parallel review..
---
